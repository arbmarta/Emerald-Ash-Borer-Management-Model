...
def apply_discount_rate(simulation_results, annual_discount_rate):
    ...
    for scenario, df in simulation_results.items():
        df = df  # Avoid modifying the original DataFrame
...
def plot_simulations_colour(discounted_results, legend_title):
...
def plot_simulations_black_and_white(discounted_results, legend_title):
    # Define scenarios and corresponding colors for plotting
    scenarios = discounted_results.keys()
...
for removal_rate in set_removal_rate:
    # Run the simulation
    results = simulate_remove_then_replant(removal_rate)
...
plot_simulations_colour(discounted_results, legend_title)
plot_simulations_black_and_white(discounted_results, legend_title)

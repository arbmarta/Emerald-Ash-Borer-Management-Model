...
from Simulation_Plotter_Individual import *

simulation_results_future_value = run_simulations(starting_ash_trees, starting_diameter, starting_diameter_new, growth_rate,
...
plot_simulations_colour(simulation_results_future_value)
plot_simulations_black_and_white(simulation_results_future_value)
plot_simulations_colour_standalone(simulation_results_future_value)
plot_simulations_black_and_white_standalone(simulation_results_future_value)
...
plot_simulations_colour_present_value(simulation_results_present_value)
plot_simulations_black_and_white_present_value(simulation_results_present_value)

report_years_future_values(simulation_results_future_value, years_to_report, output_csv)
report_years_present_values(simulation_results_present_value, years_to_report, output_csv)
